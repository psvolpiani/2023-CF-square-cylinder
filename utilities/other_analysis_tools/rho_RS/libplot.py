...
def plot_contour(data1, vari1, data2 = None, vari2 = None, data3 = None, vari3 = None, ref_length = 1.0, filename = 'countour.png', vmin = -0.2, vmax = 1.4, nlevels = 17, title=None):
    ...
    bounds=[0.0,vmax*0.5,vmax]
    fig.colorbar(cntr, ax=ax, ticks=bounds)
