...
def plot_contour(data1, vari1, data2 = None, vari2 = None, data3 = None, vari3 = None, ref_length = 1.0, filename = 'countour.png', vmin = 0.0, vmax = 1.0, nlevels = 17, title=None):
    fig, ax = plt.subplots(figsize=(6,2))

    cntr = ax.pcolormesh(data1.xi/ref_length,data1.yi/ref_length,vari1, cmap="jet", vmin=vmin, vmax=vmax,)
